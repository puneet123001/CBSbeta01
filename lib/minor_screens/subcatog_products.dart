...
class SubCatogProducts extends StatefulWidget {
  ...
  const SubCatogProducts({Key? key,required this.subcatogName,required this.maincatogName}) : super(key: key);
...
class _SubCatogProductsState extends State<SubCatogProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _productStream = FirebaseFirestore.instance
        .collection('products')
        .where('maincateg', isEqualTo: widget.maincatogName).where('subcateg',isEqualTo: widget.subcatogName)
        .snapshots();
